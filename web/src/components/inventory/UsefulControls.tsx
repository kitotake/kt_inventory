// components/inventory/UsefulControls.tsx
import { Locale } from '../../store/locale';
import React from 'react';
import { FloatingFocusManager, FloatingOverlay, FloatingPortal, useDismiss, useFloating, useInteractions, useTransitionStyles } from '@floating-ui/react';

interface Props { infoVisible: boolean; setInfoVisible: React.Dispatch<React.SetStateAction<boolean>>; }
            ...
            <FloatingFocusManager context={context}>
              <div ref={refs.setFloating} {...getFloatingProps()} className="useful-controls-dialog" style={styles}>
                <div className="useful-controls-dialog-title">
                  <p>{Locale.ui_usefulcontrols || 'Contrôles utiles'}</p>
                ...
                <div className="useful-controls-content-wrapper">
                  <p><kbd>Clic droit</kbd><br />{Locale.ui_rmb}</p>
                  <p><kbd>ALT + Clic</kbd><br />{Locale.ui_alt_lmb}</p>
                  <p><kbd>CTRL + Clic</kbd><br />{Locale.ui_ctrl_lmb}</p>
                  <p><kbd>SHIFT + Glisser</kbd><br />{Locale.ui_shift_drag}</p>
                  <p><kbd>CTRL+SHIFT+Clic</kbd><br />{Locale.ui_ctrl_shift_lmb}</p>
                </div>
              </div>
